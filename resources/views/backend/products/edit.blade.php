                            ...
                            <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" name="discount_price" value="{{ old('discount_price', $product->discount_price) }}" step="0.01" min="0" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    @if($product->thumbnail)
                                        <img src="{{ asset($product->thumbnail) }}" width="100" class="mb-2 rounded">
                                    @endif
