...
@media(max-width:768px){ .listing-layout{ grid-template-columns:1fr; } .product-grid{ grid-template-columns:repeat(1,1fr); } }
@media(max-width:600px){ .product-image-container{ height: 150px; } }
</style>
@endsection
